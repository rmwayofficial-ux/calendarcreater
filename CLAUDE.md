# calendarcreater — CCAGI SDK Project
...
@import .claude/rules/vcs-rules.md
...
*CCAGI SDK — Standard tier (MCP: 2 servers)*
Powered by CCAGI SDK v4.22.13
