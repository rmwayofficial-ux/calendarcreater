    ...
    <article className="page">
      ...
      <section className="page-sec">
        ...
        <ol className="page-steps">
          <li><b>月とタイトルを選ぶ</b><br />画面左上の ◀ ▶ やプルダウンで年月を選び、タイトル（例：「6月の予約状況」）を入力します。</li>
          <li><b>各日の午前・午後をタップ</b><br />日にちのマスにある「午前」「午後」を押すたびに <span className="nowrap">空白 → ◎ → ○ → △ → ×</span> と切り替わります。</li>
      ...
      <section className="page-sec">
        ...
        <ul className="page-list">
          <li><b>やわらか</b>：丸み・淡い色・やさしい雰囲気。季節のイラスト入り。</li>
          <li><b>クール</b>：すっきりモダン。背景は季節の色に変わりますが、イラストは付きません。</li>
          <li><b>シャープ</b>：背景色は変わらない無地でクリアな印象。毎月、月日だけが変わります。</li>
          <li><b>あたたか</b>：温かみ・ナチュラル。季節のイラスト入り。</li>
        </ul>
      </section>
